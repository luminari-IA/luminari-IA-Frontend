    ...
    <AuthLayout leftPanelContent={leftPanel}>
      ...
      <div className="d-flex flex-column gap-3 mb-4">
        <div>
          ...
          <input type="text" className="lum-input" placeholder="Sofía Martínez" />
        </div>
        <div>
          <label className="d-block mb-1" style={{ fontSize: '.8rem', color: 'var(--lum-muted)', fontWeight: 600 }}>
            Correo electrónico
        ...
        <div>
          ...
          <input type="password" className="lum-input" placeholder="Mínimo 8 caracteres" />
        </div>
      </div>

      <div className="d-flex align-items-center gap-2 mb-4">
        <input type="checkbox" id="terms" style={{ accentColor: 'var(--lum-primary)' }} />
      ...
      <Link to="/onboarding/intereses" className="btn-lum btn-lum-primary w-100 justify-content-center" style={{ padding: '13px' }}>
        Crear cuenta y continuar <i className="bi bi-arrow-right ms-1" />
      </Link>
